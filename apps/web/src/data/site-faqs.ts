...
/**
 * Site-wide FAQ content — the single source of truth shared by the visible FAQ
 * accordion (`components/catalog/Faq.tsx`) and the `FAQPage` structured data on
 * `/faq`. Answers are plain strings so they can be dropped straight into JSON-LD;
 * the accordion linkifies the contact email at render time.
 */
...
export const SITE_FAQS: SiteFaq[] = [
  ...
  },
  {
    ...
    a: `Suggestions and bug reports are welcome — email ${CONTACT_EMAIL}.`,
  },
];
